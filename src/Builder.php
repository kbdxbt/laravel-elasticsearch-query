...
namespace Kbdxbt\ElasticSearchQuery;
...
class Builder
{
     ...
     * @return stdClass
     */
    public function bulk(array $data, $id = null, $key = 'id'): stdClass
    {
        foreach ($data as $val) {
            $id = $id ? $id : isset($val[$key]) ? $val[$key] : uniqid();
        ...
        $result = $this->runQuery(
            $this->grammar->compileBulk($this, $params),
            'bulk'
        );
        ...
        return (object) count($result['items']);
    }
